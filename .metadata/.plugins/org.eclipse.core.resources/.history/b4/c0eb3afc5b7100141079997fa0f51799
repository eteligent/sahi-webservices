...
// Generated Oct 28, 2014 1:47:05 PM by Hibernate Tools 3.2.2.GA
...
/**
 * TbGetPtnShortpaymInfo generated by hbm2java
 */

@Entity
@Table(name="tb_get_ptn_shortpaym_info"
    ,catalog="db_integ_aas"
)
@NamedQueries(@NamedQuery(name = "TbGetPtnShortpaymInfo.getPtnInfo", 
query = "SELECT tbl FROM TbGetPtnShortpaymInfo tbl WHERE tbl.payTrackNum = :payTrackNum AND tbl.payorName = :payorName AND tbl.brCode = :brCode AND tbl.date = :date"))
public class TbGetPtnShortpaymInfo  implements java.io.Serializable {
    ...
    public TbGetPtnShortpaymInfo() {
    }

    public TbGetPtnShortpaymInfo(String payTrackNum, String payorName, String brCode, Date date, String payorId, String payorAddress, String payorType, int paymMode, int currCode, BigDecimal amt) {
