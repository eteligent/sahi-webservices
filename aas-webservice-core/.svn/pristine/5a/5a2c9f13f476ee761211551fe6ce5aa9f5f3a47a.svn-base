...
// Generated Nov 3, 2014 10:19:14 AM by Hibernate Tools 3.2.2.GA
...
public class TBLGetDuePdcSummary  implements java.io.Serializable {
    ...
    public TBLGetDuePdcSummary() {
    }

	
    public TBLGetDuePdcSummary(String brCode, Date pdcDate, String payorName, String payTrackNum, String pdcRefNo, String payorType, BigDecimal amtForPayment, int paymMode, String bankCode, String bankName, String checkNo, Date checkDate, String checkType, int currCode) {
        this.brCode = brCode;
    ...
    public TBLGetDuePdcSummary(String brCode, Date pdcDate, String payorName, String payTrackNum, String pdcRefNo, String payorId, String payorAddress, String payorType, BigDecimal amtForPayment, int paymMode, String bankCode, String bankName, String checkNo, Date checkDate, String checkType, int currCode) {
       this.brCode = brCode;
       this.pdcDate = pdcDate;
       this.payorName = payorName;
       this.payTrackNum = payTrackNum;
