 ...
 *       &lt;sequence>
 *         &lt;element name="Response_Code" type="{http://schema.pagibig.aas.gov}status"/>
 *         &lt;element name="Response_Message" type="{http://schema.pagibig.aas.gov}status"/>
...
@XmlRootElement(name = "integ_otc_insert_acq_pof_detailResponse")
public class IntegOtcInsertAcqPofDetailResponse {
